    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="laboratoriomodifica.html"><i class="fa fa-edit "></i>Modifica Profilo  <span class="badge"></span></a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2>Area Riservata Laboratorio</h2>   
                    </div>
                </div>              
                
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <h5><b>LISTA TAMPONI EFFETTUATI O DA EFFETTUARE</b></h5>
                        ...
                        <button type=”submit”> Comunica Risultati </button>
                        <button type=”submit”> Comunica Risultati all'AS</button>
                        </form>
