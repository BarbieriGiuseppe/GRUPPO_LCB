    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="datorelavoroindex.html" ><i class="fa fa-desktop "></i>Dashboard <span class="badge"></span></a>
                    </li>
                   

                    <li>
                        <a href="datorelavoroprenotazione.html"><i class="fa fa-table "></i>Prenotazione  <span class="badge"></span></a>
                    </li>
                    <li>
                        <a href="datorelavoromodifica.html"><i class="fa fa-edit "></i>Modifica Profilo  <span class="badge"></span></a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2>Area Riservata Datore di Lavoro</h2>   
                    </div>
                </div>              
