    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="medicocuranteindex.html" ><i class="fa fa-desktop "></i>Dashboard <span class="badge"></span></a>
                    </li>
                   

                    <li>
                        <a href="medicocuranteprenotazione.html"><i class="fa fa-table "></i>Prenotazione  <span class="badge"></span></a>
                    </li>
                    <li>
                        <a href="medicocurantemodifica.html"><i class="fa fa-edit "></i>Modifica Profilo  <span class="badge"></span></a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2>Area Riservata Medico Curante</h2>   
                    </div>
                </div>              
                
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <h5><b>LISTA PRENOTAZIONI ASSISTITI</b></h5>
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>@mdo</td>
                                    <td>@mdo</td>
                                    <td> <img src="/img/deleteicon.jpg" /></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Jacob</td>
        ...
        <br>  <button type=”submit”> Comunica Risultati </button>
