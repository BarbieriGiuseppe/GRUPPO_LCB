...
<html lang="en">
<head>
	<title>Accesso Laboratori</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form">
					<span class="login100-form-title p-b-70">
						...
						Area Riservata Laboratori Convenzionati
					</span>
					<span class="login100-form-avatar">
						<img src="<?php echo url('/img'); ?>/laboratorio.png" alt="LABORATORIO">
					</span>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Codice Privato">
						<input class="input100" type="text" name="Codice Privato">
						<span class="focus-input100" data-placeholder="Codice Privato"></span>
					</div>
					...
					<ul class="login-more p-t-190">
						...
						<li>
							<span class="txt1">
								Non sei un laboratorio convenzionato?
							</span>
