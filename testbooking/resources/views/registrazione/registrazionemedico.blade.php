		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Data Nascita" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Data Nascita">
						<span class="focus-input100" data-placeholder="Data Nascita"></span>
					</div>

					
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Nazionalità" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Nazionalità">
						<span class="focus-input100" data-placeholder="Nazionalità"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Residenza" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Residenza">
						<span class="focus-input100" data-placeholder="Residenza(indirizzo)"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Città" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Città">
						<span class="focus-input100" data-placeholder="Città residenza"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Provincia" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Provincia">
						<span class="focus-input100" data-placeholder="Provincia residenza"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci CAP" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="CAP">
						<span class="focus-input100" data-placeholder="CAP residenza"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Domicilio" style = "position:relative; left:-180px; top:-10px; ">
						<input class="input100" type="text" name="Domicilio">
						<span class="focus-input100" data-placeholder="Domicilio(indirizzo)"></span>
					</div>

					<div style = "position:relative; left:260px; top:-1686px; ">
						<h5><b>Dati dello studio medico</b></h5>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Nome Studio Medico" style = "position:relative; left:260px; top:-1735px; ">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Nazione" style = "position:relative; left:260px; top:-1735px; ">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Conferma E-mail" style = "position:relative; left:260px; top:-1735px; ">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" style = "position:relative; left:260px; top:-1615px; ">
							Registrati
						</button>
					</div>
