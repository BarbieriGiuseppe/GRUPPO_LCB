			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form">
					...
					<div style = "position:relative; left:-180px; top:-70px; ">
						...
						<span class="focus-input100" data-placeholder="Nazione Laboratorio" style = "position:relative; top:-45px; "></span>
						<select name="Nazione" >
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Conferma E-mail" style = "position:relative; left:250px; top:-220px; ">
						<input class="input100" type="text" name="Conferma E-mail">
						<span class="focus-input100" data-placeholder="Conferma E-mail"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Città Laboratorio" style = "position:relative; left:-180px; top:-240px; ">
						<input class="input100" type="text" name="Città Laboratorio">
						<span class="focus-input100" data-placeholder="Città Laboratorio"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Inserisci la password" style = "position:relative; left:250px; top:-329px; ">
						<input class="input100" type="password" name="Password">
						<span class="focus-input100" data-placeholder="Password"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Indirizzo Laboratorio" style = "position:relative; left:-180px; top:-355px; ">
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Conferma la password" style = "position:relative; left:250px; top:-445px; ">
						<input class="input100" type="password" name="Password">
						<span class="focus-input100" data-placeholder="Conferma Password"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Provincia Laboratorio" style = "position:relative; left:-180px; top:-470px; ">
					...
					<div class="container-login100-form-btn"  style = "position:relative; left:250px; top:-555px; ">
						<button class="login100-form-btn">
							Convenzionati
						</button>
					</div>

					<div style = "position:relative; left:30px; top:-550px; ">
						<br>
						<p>Dopo essersi convenzionati si verrà a conoscenza di: <br> 
											
					</div>

					<div style = "position:relative; left:-40px; top:-550px; ">
						<br>
						<nobr>
