		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Residenza" style = "position:relative; left:-180px; top:30px; ">
					...
					<div style = "position:relative; left:260px; top:-1650px; ">
						<h5><b>Dati dell'Azienda</b></h5>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Ragione Sociale" style = "position:relative; left:260px; top:-1698px; ">
						<input class="input100" type="text" name="Ragione Sociale">
						<span class="focus-input100" data-placeholder="Ragione Sociale"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Partita IVA" style = "position:relative; left:260px; top:-1698px; ">
						<input class="input100" type="text" name="Partita IVA">
						<span class="focus-input100" data-placeholder="Partita IVA"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Ruolo Aziendale" style = "position:relative; left:260px; top:-1698px; ">
						<input class="input100" type="text" name="Ruolo Aziendale">
						<span class="focus-input100" data-placeholder="Ruolo Aziendale"></span>
					</div>

					<div style = "position:relative; left:260px; top:-1620px; ">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Città" style = "position:relative; left:260px; top:-1620px; ">
						<input class="input100" type="text" name="Città">
						<span class="focus-input100" data-placeholder="Città"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Indirizzo" style = "position:relative; left:260px; top:-1590px; ">
						<input class="input100" type="text" name="Indirizzo">
						<span class="focus-input100" data-placeholder="Indirizzo"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci Provincia" style = "position:relative; left:260px; top:-1600px; ">
						<input class="input100" type="text" name="Provincia">
						<span class="focus-input100" data-placeholder="Provincia"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Inserisci E-mail" style = "position:relative; left:260px; top:-1618px; ">
						<input class="input100" type="text" name="E-mail">
						<span class="focus-input100" data-placeholder="E-mail"></span>
					</div>

					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Conferma E-mail" style = "position:relative; left:260px; top:-1618px; ">
						<input class="input100" type="text" name="Conferma E-mail">
						<span class="focus-input100" data-placeholder="Conferma E-mail"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Inserisci la password" style = "position:relative; left:260px; top:-1568px; ">
					...
					<div class="container-login100-form-btn" style = "position:relative; left:260px; top:-1500px; ">
