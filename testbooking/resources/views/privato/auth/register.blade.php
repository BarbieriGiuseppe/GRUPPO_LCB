			...
			<div class="wrap-login100 p-t-85 p-b-20">
				<form method="POST" action="{{ route('privato.register') }}">
					...
					<span class="login100-form-avatar">
						<img src="<?php echo url('/img'); ?>/utente.png" alt="PRIVATO">
					</span>

					<div style = "position:relative; left:-180px; top:40px; ">
						<h5><b>{{ __('Dati Del Privato') }}</b></h5>
					</div>
					...
					<div class="wrap-input100 validate-input m-t-250 m-b-35" data-validate = "Inserisci E-mail" style = "position:relative; left:260px; top:-1735px; ">
