            ...
            <div id="page-inner">
                <div class="container">
                    <ul class="progressbar">
                        <li class="active"> Dati Dipendente</li>
                ...
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                 <!-- /. ROW  --> 
     <form method="POST" action="{{ route('azienda.registerTamponato') }}">
		@csrf
    
    <div class="input-group"> 
         <h5> Codice Fiscale</h5>
        <input id="codicefiscaledipendente" type="text" required class="form-control" name = "codicefiscaledipendente">
        @error('codicefiscaledipendente')
