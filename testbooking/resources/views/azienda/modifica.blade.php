        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <form action= "/azienda/aggiorna " method="get">

    

                    <div class="input-group">
                        <h4><b>Codice Fiscale</b></h4>
                        <input name='codicefiscale' id='codicefiscale' type="text" readonly value="{{ Auth::guard('azienda')->user()->codicefiscale }}" class="form-control"  />
                    </div>
                    ...
                    <div class="input-group">
                         <h4><b>Cognome</b></h4>
                        <input name='cognome' id='cognome' type="text"  value="{{ Auth::guard('azienda')->user()->cognome}}" class="form-control" />
                    </div>
                    ...
                    <div class="input-group">
                        <h4><b>Nome</b></h4>
                        <input name='nome' id='nome' type="text" value="{{ Auth::guard('azienda')->user()->nome }}"  class="form-control" />
                    </div>
                                
                    
                    <div class="input-group">
                        <h4><b>Telefono</b></h4>  
                        <input name='telefono' id='telefono' type="text" value="{{ Auth::guard('azienda')->user()->telefono }}" class="form-control"/>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input name='luogonascita' id='luogonascita' type="text" value="{{ Auth::guard('azienda')->user()->luogonascita }}" class="form-control" />
                    </div>
                
                    <div class="wrapper">
                        <h4><b>Data Di Nascita</b></h4>
                        <label>
                            <input name='datanascita' id='datanascita' type="date"  value="{{ Auth::guard('azienda')->user()->datanascita }}" class="dateselect" required="required"/>
                        </label>
                    ...
                    <div class="input-group" style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>Residenza</b></h4>   
                        <input name='residenza' id='residenza' type="text" value="{{ Auth::guard('azienda')->user()->residenza }}" class="form-control"/>
                    </div>
                    ...
                    <div class="input-group" style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>Città</b></h4>  
                        <input name='citta' id='citta' type="text" value="{{ Auth::guard('azienda')->user()->citta }}" class="form-control"  />
                    </div>
                    ...
                    <div class="input-group" style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>Provincia</b></h4>  
                        <input name='provincia' id='provincia' type="text" value="{{ Auth::guard('azienda')->user()->provincia }}" class="form-control"  />
                    </div>
                    ...
                    <div class="input-group" style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>CAP</b></h4>  
                        <input name='cap' id='cap' type="text" value="{{ Auth::guard('azienda')->user()->cap }}" class="form-control"  />
                    </div>
                    
                    <div class="input-group" style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>Nazione</b></h4>
                        <select name="nazione" id='nazione' type="text" class="form-control @error('nazione') is-invalid @enderror" name="nazione" value="{{ Auth::guard('azienda')->user()->nazione}}" required autocomplete="nazione" autofocus>
                    ...
                    <div class="input-group"  style = "position:relative; left:260px; top:-450px; ">
                        <h4><b>Email</b></h4>  
                        <input name='email' id='email' type="text" value="{{ Auth::guard('azienda')->user()->email }}" class="form-control"/>
                    </div>
                    
                    <!--<<div class="input-group"  style = "position:relative; left:490px; top:-450px; ">
                        <h5>Password</h5>  
                        <input name='password' id='password' type="password" value="{{ Auth::guard('azienda')->user()->password }}" class="form-control" />
                    </div>-->
    
                    
                    <div class="input-group" style = "position:relative; left:630px; top:-890px; ">
                        <h4><b>Ragione Sociale</b></h4>  
                        <input name='ragionesociale' id='ragionesociale' type="text" value="{{ Auth::guard('azienda')->user()->ragionesociale }}" class="form-control"/>
                    </div>
                    
                    <div class="input-group" style = "position:relative; left:630px; top:-890px; ">
                        <h4><b>Partita Iva</b></h4>  
                        <input name='partitaiva' id='partitaiva' type="text" value="{{ Auth::guard('azienda')->user()->partitaiva }}" class="form-control"/>
                    </div>
    
                    <div class="input-group" style = "position:relative; left:630px; top:-890px; ">
                        <h4><b>Indirizzo Azienda</b></h4>  
                        <input name='indirizzoazienda' id='indirizzoazienda' type="text" value="{{ Auth::guard('azienda')->user()->indirizzoazienda }}" class="form-control"/>
                    </div>
    
                    <div class="input-group" style = "position:relative; left:630px; top:-890px; ">
                        <h4><b>Citta Azienda</b></h4>  
                        <input name='cittaazienda' id='cittaazienda' type="text" value="{{ Auth::guard('azienda')->user()->cittaazienda }}" class="form-control"/>
                    </div>
    
                    
                    <div class="input-group" style = "position:relative; left:630px; top:-890px; ">
                        <h4><b>Provincia Azienda</b></h4>  
                        <input name='provinciaazienda' id='provinciaazienda' type="text" value="{{ Auth::guard('azienda')->user()->provinciaazienda }}" class="form-control"/>
                    </div>
