					...
					<div class="card-body">
						<form method="POST" action="{{ route('medico.register') }}">
						  ...
						  <option value="ZW">Zimbabwe</option>
							...
							<div class="form-group row">
								<label for="nomestudio" class="col-md-4 col-form-label text-md-right">{{ __('Nome Studio Medico') }}</label>
	
								<div class="col-md-4">
									<input id="nomestudio" type="text" class="form-control @error('nomestudio') is-invalid @enderror" name="nomestudio" value="{{ old('nomestudio') }}" required autocomplete="nomestudio" autofocus>
