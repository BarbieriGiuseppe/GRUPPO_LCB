	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
					...
					<form method="POST" action="{{ route('medico.login') }}" class="login100-form validate-form">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="container-login100-form-btn">
                                ...
                                @if (Route::has('medico.password.request'))
                                    <a class="login-more p-t-70" href="{{ route('medico.password.request') }}">
